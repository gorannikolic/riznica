...
environments {
  development {
    ...
    dataSource {
      ...
      url = "jdbc:h2:mem:devDb;MVCC=TRUE;MODE=DB2;LOCK_TIMEOUT=10000;DB_CLOSE_ON_EXIT=FALSE"
    }
  }
  test {
    riznica.bootstrap.createAllBootStrapData = true
    dataSource {
      dbCreate = "create-drop"
      url = "jdbc:h2:mem:testDb;MVCC=TRUE;MODE=DB2;LOCK_TIMEOUT=10000;DB_CLOSE_ON_EXIT=FALSE"
    }
  }
  production {
    dataSource {
